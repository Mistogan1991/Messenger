...
public sealed class PromoteAdminHandler : IRequestHandler<PromoteAdminCommand, Result>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IChatRepository _chatRepository;

    public PromoteAdminHandler(
    ...
    public async Task<Result> Handle(PromoteAdminCommand request, CancellationToken ct)
    {
        ...
        chat.PromoteAdmin(request.UserId);
