...
{
    public sealed class ArchiveChatHandler : IAppRequestHandler<ArchiveChatCommand>
    {
        ...
        public async Task<Result> Handle(ArchiveChatCommand request, CancellationToken ct)
        {
            ...
            chat.ArchiveChat(_currentUser.UserId);
