...
{
    public sealed class MuteChatHandler : IAppRequestHandler<MuteChatCommand>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ICurrentUser _currentUser;
        private readonly IChatRepository _chatRepository;

        public MuteChatHandler(
        ...
        public async Task<Result> Handle(MuteChatCommand request, CancellationToken ct)
        {
            ...
            chat.MuteChat(_currentUser.UserId);
