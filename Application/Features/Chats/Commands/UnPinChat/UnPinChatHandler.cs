...
{
    public sealed class UnPinChatHandler : IAppRequestHandler<UnPinChatCommand>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ICurrentUser _currentUser;
        private readonly IChatRepository _chatRepository;

        public UnPinChatHandler(
        ...
        public async Task<Result> Handle(UnPinChatCommand request, CancellationToken ct)
        {
            ...
            chat.UnPinChat(_currentUser.UserId);
